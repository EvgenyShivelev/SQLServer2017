...
- В базе данных содержится информаиця о месте работе, должности в издательстве (Например Менеджер), уровень работы(сложности раюоты).
- Каждый издатель имеет подробную финансовую информацию и отчетность об работе авторов. 
### Выделим базовые сущности этой предметной области:
- Сотрудники изательств. Атрибуты сотрудников – ФИ, табельный номер, идентификатор по которому определяется вид работы, уровень работы, идентификатор издателя на котрого он работает, дата устройства на работу.
...
- Публикация. Атрибуты публикации – автор, название, налоги, дата публикации, примечания, годовые продажи, цена, роялти, идентификатор издательства, тип публикации, тип публикации.
...
***Роялти - плата, которую автор платит издателю за ресурсы, то есть определенный процент от продаж*** 
